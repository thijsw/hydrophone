#!/bin/bash
# Publish a Hydrophone release to GitHub Releases (with the app as download):
#
...
PBXPROJ=Hydrophone.xcodeproj/project.pbxproj
...
APP="build/export-developer-id/Hydrophone.app"
...
gh release create "v$VERSION" "$ZIP" --title "Hydrophone $VERSION" --generate-notes
